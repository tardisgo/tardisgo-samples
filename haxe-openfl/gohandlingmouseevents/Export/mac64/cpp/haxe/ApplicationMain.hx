...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("OpenFL Technologies", "HandlingMouseEvents", "org.openfl.samples.handlingmouseevents", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Handling Mouse Events", null, { width: 800, height: 600 });
