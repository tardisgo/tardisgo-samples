...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("OpenFL Technologies"),HX_CSTRING("HandlingMouseEvents"),HX_CSTRING("org.openfl.samples.handlingmouseevents"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(32)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Handling Mouse Events"),null(),null());
	}
return null();
}
