...
- [8concurrentgophers](https://github.com/tardisgo/tardisgo-samples/tree/master/openfl/8concurrentgophers/Source) (as above, but with 8 gophers rather than 2, for FOSDEM14 presentation; modified 19-Mar-2014 to use new openfl-html5 back-end) - NOT WORKING (still to be rewritten in-line with API changes Dec-2014)
